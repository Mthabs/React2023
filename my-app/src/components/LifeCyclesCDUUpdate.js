...
import LifeCyclesCDUChildUpdate from './LifeCyclesCDUChildUpdate';

export class LifeCyclesCDUUpdate extends Component {
    constructor(props) {
    ...
    render() {
        ...
        return (
            <div>
                ...
                <LifeCyclesCDUChildUpdate/>
            </div>
        )
    }
}

export default LifeCyclesCDUUpdate
